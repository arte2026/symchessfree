...
if (pieceType === "king") {
    ...
    // King moved more than 1 square horizontally → Castling
    if (fileDiff > 1) {
        performCastling(
            piece,
            pieceColor,
  ...
  const isLastRank = move.to[1] === "8"; // Black promotes on rank 1
  let promotedType = "blank";
  
  if (isPawn && isLastRank) {
     piece.src = "White-Queen3.png"; // Ensure this filename matches your assets
